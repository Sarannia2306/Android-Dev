...
public class RegistrationActivity extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        if (currentUser != null) {
            Intent intent = new Intent(getApplicationContext(), com.example.fitness.RegistrationActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn.setOnClickListener(view -> {
            ...
            if (email.equals("admin24Gym@gmail.com") && password.equals("230601")) {
